Elementum daemon [![Build Status](https://travis-ci.org/m/elementum.svg?branch=master)](https://travis-ci.org/masqchips/elementum)
======
...
3. go get
    ...
    ```
    go get -d github.com/masqchips/elementum
    ```
